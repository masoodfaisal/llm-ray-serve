...
@serve.deployment(name="LLamaCPPDeployment", ray_actor_options={"num_cpus": 13}, autoscaling_config={"min_replicas" : 5, "max_replicas": 5, "initial_replicas": 5, "upscale_delay_s": 5}, max_ongoing_requests=100, graceful_shutdown_timeout_s=600)
@serve.ingress(app)
